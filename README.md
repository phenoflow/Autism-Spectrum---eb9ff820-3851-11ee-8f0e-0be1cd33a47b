...
Specify input dataset path in [Autism-Spectrum-inputs.yml](Autism-Spectrum-inputs.yml).

## Usage

Run: `cwltool Autism-Spectrum.cwl Autism-Spectrum-inputs.yml`
